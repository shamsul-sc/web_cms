                            ...
                            <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user"
                                        src="{{ asset('img/user-dummy-img.jpg') }}" alt="Header Avatar">
            ...
            <div id="scrollbar">
                <div class="container-fluid ">
                    ...
                    <ul class="navbar-nav " id="sortable">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarPages">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{ route('dashboard.category_list') }}" class="nav-link"
                                            data-key="t-category-list">
                                            Category List
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#sidebarMachineries" class="nav-link" data-bs-toggle="collapse"
                                            role="button" aria-expanded="false" aria-controls="sidebarMachineries"
                                            data-key="t-Machineries"> Machineries
                                        </a>
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarSpareParts" class="nav-link" data-bs-toggle="collapse"
                                            role="button" aria-expanded="false" aria-controls="sidebarSpareParts"
                                            data-key="t-Spare-parts"> Spare-parts
                                        </a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarWorkforces" data-bs-toggle="collapse"
                                role="button" aria-expanded="false" aria-controls="sidebarWorkforces">
                                <i class="ri-pages-line"></i>
                            ...
                            <div class="collapse menu-dropdown" id="sidebarWorkforces">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="#sidebarMechanics" class="nav-link" data-bs-toggle="collapse"
                                            role="button" aria-expanded="false" aria-controls="sidebarMechanics"
                                            data-key="t-Mechanics"> Mechanics
                                        </a>
                                        <div class="collapse menu-dropdown" id="sidebarMechanics">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="{% url 'mechanics_list' %}" class="nav-link"
                                                        data-key="t-Mechanic-List"> Mechanic List</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="{% url 'create_mechanics' %}" class="nav-link"
                                                        data-key="t-Mechanic-Create"> Mechanic Create </a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#sidebarDriver" class="nav-link" data-bs-toggle="collapse"
                                            role="button" aria-expanded="false" aria-controls="sidebarDriver"
                                            data-key="t-Driver"> Driver
                                        </a>
                                        <div class="collapse menu-dropdown" id="sidebarDriver">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="{% url 'driver_list' %}" class="nav-link"
                                                        data-key="t-Driver-List">Driver List</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="{% url 'create_driver' %}" class="nav-link"
                                                        data-key="t-Driver-Create">Driver Create</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarServices">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{% url 'service_type_list' %}" class="nav-link"
                                            data-key="t-starter">Service Type List</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{% url 'service_list' %}" class="nav-link"
                                            data-key="t-starter">Services List</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{% url 'create_service' %}" class="nav-link"
                                            data-key="t-starter">Services Create</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarOthers">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="#sidebarManufacturer" class="nav-link" data-bs-toggle="collapse"
                                            role="button" aria-expanded="false" aria-controls="sidebarManufacturer"
                                            data-key="t-Manufacturer"> Manufacturer
                                        </a>
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarGovFacilities" class="nav-link" data-bs-toggle="collapse"
                                            role="button" aria-expanded="false" aria-controls="sidebarGovFacilities"
                                            data-key="t-GovFacilities"> GovFacilities
                                        </a>
                                    ...
                                    <li class="nav-item">
                                        <a href="#sidebarVideos" class="nav-link" data-bs-toggle="collapse"
                                            role="button" aria-expanded="false" aria-controls="sidebarVideos"
                                            data-key="t-Videos"> YouTube Videos
                                        </a>
                                        <div class="collapse menu-dropdown" id="sidebarVideos">
                                            <ul class="nav nav-sm flex-column">
                                                <li class="nav-item">
                                                    <a href="{% url 'video_list' %}" class="nav-link"
                                                        data-key="t-video-list">Video List</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="{% url 'entry_video' %}" class="nav-link"
                                                        data-key="t-video-create">Video Create</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#sidebarContributor" class="nav-link" data-bs-toggle="collapse"
                                            role="button" aria-expanded="false" aria-controls="sidebarContributor"
                                            data-key="t-contributor"> Contributor
                                        </a>
