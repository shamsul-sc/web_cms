            ...
            <div class="card-body ">
                    ...
                    <form action="{{ route('dashboard.faq_category_update',$getRecord->id) }}" method="POST">
                        ...
                        <div class="col-md-12 outlined-input-container">
                            <select class="form-select" name="faq_cat_status" required>
                                <option value="" disabled {{ old('faq_cat_status', $getRecord->faq_cat_status) === null
                                    ? 'selected' :
                                    '' }}>
                                    Select Status
                                </option>
                                <option value="Show" {{ old('faq_cat_status', $getRecord->faq_cat_status) == 'Show' ?
                                    'selected' : ''
                                    }}>Show</option>
                                <option value="Hide" {{ old('faq_cat_status', $getRecord->faq_cat_status) == 'Hide' ?
                                    'selected' : ''
                                    }}>Hide</option>
                            </select>
                ...
                <div class="row">
                    <div class="col-12 text-center d-flex justify-content-between align-items-center">
                        <a href="{{ route('dashboard.faq_category_list') }}" class="btn btn-danger px-5 rounded-pill">
