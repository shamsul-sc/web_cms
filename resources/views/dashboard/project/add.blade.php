                    ...
                    <form action="{{ route('dashboard.project_insert') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12 ">
                                ...
                                <textarea id="details" name="details" class="form-control  dynamic-char-count" placeholder="" rows="5"></textarea>

                            </div>
                            <div class="col-md-12 mt-4 ">
                                <label for="details_bn">Details (Bangla)<span class="required">*</span></label>
                                <textarea id="details_bn" name="details_bn" class="form-control  dynamic-char-count" placeholder="" rows="5"></textarea>
