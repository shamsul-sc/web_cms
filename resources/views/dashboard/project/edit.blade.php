                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 outlined-input-container">
                                <select id="joint_project" name="joint_project" class="form-select">
                                    <option value="" disabled {{ old('joint_project', $getRecord->joint_project) ===
                                        null ? 'selected' :
                                        '' }}>
                                        Select Project
                                    </option>
                                    <option value="No" {{ old('joint_project', $getRecord->joint_project) == 'No' ?
                                        'selected'
                                        : ''
                                        }}>No</option>
                        ...
                        <div class="row">
                            <div class="col-md-6 outlined-input-container">
                                <select id="featured_project" name="featured_project" class="form-select">
                                    <option value="" disabled {{ old('featured_project', $getRecord->featured_project)
                                        ===
                                        null ? 'selected' :
                                        '' }}>
                                    <option value="No" {{ old('featured_project', $getRecord->featured_project) == 'No'
                                        ? 'selected'
                                        : ''
                                        }}>No</option>
                                    <option value="Yes" {{ old('featured_project', $getRecord->featured_project) ==
                                        'Yes'
                                        ? 'selected'
                                        : ''
                                        }}>Yes</option>
                            ...
                            <div class="col-md-6 outlined-input-container">
                                <select id="state" name="state" class="form-select">
                                    <option value="" disabled {{ old('state', $getRecord->state) ===
                                        null ? 'selected' :
                                        '' }}>
                                        Select State
                                    <option value="Planning" {{ old('state', $getRecord->status) == 'Planning' ?
                                        'selected'
                                        : ''
                                        }}>Planning</option>
                                    <option value="Running" {{ old('state', $getRecord->status) == 'Running' ?
                                        'selected'
                                        : ''
                                        }}>Running</option>
                                    <option value="Finished" {{ old('state', $getRecord->status) == 'Finished' ?
                                        'selected'
                                        : ''
                                        }}>Finished</option>
                                </select>
                            ...
                            <div class="col-md-6 outlined-input-container">
                                <select class="form-select" name="status">
                                    <option value="" disabled {{ old('status', $getRecord->status) ===
                                        null ? 'selected' :
                                        '' }}>
                                        Select
