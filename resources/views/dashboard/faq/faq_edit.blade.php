                    ...
                    <div class="card-body  mt-2">
                        ...
                        <form action="{{ route('dashboard.faq_update', $getRecord->id) }}" method="POST"
                                    ...
                                    <select id="faq_cat_id" name="faq_cat_id" class="form-select">
                                        ...
                                        @foreach ($getFaqCategory as $faq_category)
                                            <option value="{{ $faq_category->id }}"
                                                {{ $faq_category->id == $faq_category->id ? 'selected' : '' }}>
                                                {{ $faq_category->faq_cat_name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 outlined-input-container">
                                    <input type="text" id="answer_bn" name="answer_bn" class="form-control"
                                        placeholder="" value="{{ old('answer_bn', $getRecord->answer_bn) }}" maxlength="100">
                            ...
                            <div class="row">
                                <div class="col-12 text-center d-flex justify-content-between align-items-center">
                                    <a href="{{ route('dashboard.faq_list') }}"
