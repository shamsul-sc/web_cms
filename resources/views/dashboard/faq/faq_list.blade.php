    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-header d-flex align-items-center" style="background-color: rgb(93, 198, 93);">
                <h5 class="card-title flex-grow-1 mb-0 text-white">FAQ List</h5>
                <div class="flex-shrink-0">
                    <a class="btn btn-soft-info waves-effect waves-light text-black"
                        href="{{ route('dashboard.faq_add') }}">Add New
                        FAQ</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td class='d-flex mt-4 gap-1'>
                            ...
                            <form id="delete-form-{{ $value->id }}"
                                action="{{ route('dashboard.faq_deleted', $value->id) }}" method="POST"
                                style="display: none;">
                                @csrf
                                @method('DELETE')
                            </form>
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-end">
                    {!! $getFaq->appends(Illuminate\Support\Facades\Request::except('page'))->links() !!}
                </div>
            </div>
        </div>
