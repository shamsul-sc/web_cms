                ...
                <div class="col">
                    <div class="p-2">
                        ...
                        <div class="hstack text-white-50 gap-1">
                            <div class="me-2"><i
                                    class="ri-map-pin-user-line me-1 text-white text-opacity-75 fs-16 align-middle"></i>{{ $getUserProfile->present_address }}
                            </div>
                            <div>
                                <i
                ...
                <div>
                    <div class="d-flex profile-wrapper">
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <a href="{{ route('dashboard.users_profile_edit', $getUser->id) }}"
                                class="btn btn-success loadButton"><i class="ri-edit-box-line align-bottom "></i> Edit
                                Profile</a>
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        @if ($getUser)
                                                            ...
                                                            <tr>
                                                                <th class="ps-0" scope="row" name="">Father Name
                                                                    :</th>
                                                                <td class="text-muted">{{ $getUserProfile->father_name }}
                                                                </td>
                                                                <th class="ps-0" scope="row">Mother Name :</th>
                                                                <td class="text-muted">{{ $getUserProfile->mother_name }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td class="text-muted">{{ $getUserProfile->blood_group }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th class="ps-0" scope="row">NID Number :</th>
                                                                <td class="text-muted">{{ $getUserProfile->nid_number }}
                                                                </td>
                                                                <th class="ps-0" scope="row">Present Address :</th>
                                                                <td class="text-muted">
                                                                    {{ $getUserProfile->present_address }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td class="text-muted">{{ $getUserProfile->date_of_birth }}
                                                                </td>
