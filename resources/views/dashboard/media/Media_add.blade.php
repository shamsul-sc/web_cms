            ...
            <div class="col-xl-12">
                ...
                <div class="card shadow-lg">
                    <div class="card-header align-items-center d-flex text-white" style="background-color: rgb(93, 198, 93);">
                        <h4 class="card-title mb-0 flex-grow-1 text-white">Add a Media Coverage</h4>
                    </div>
                    <div class="card-body mt-2">
                        <form action="{{ route('dashboard.media_cover_insert') }}" method="POST"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    <input type="file" id="media_logo" name="media_logo" class="form-control" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 outlined-input-container">
                                    <input type="url" id="url" name="url" class="form-control" placeholder=""
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12 mt-3 ">
                                    ...
                                    <textarea id="coverage_text" name="coverage_text" class="form-control dynamic-char-count" placeholder="" rows="5"></textarea>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12 mt-3 ">
                                    ...
                                    <textarea id="summary" name="summary" class="form-control dynamic-char-count" placeholder="" rows="5"></textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 mt-4 outlined-input-container">
                                    <select class="form-select" name="full_news_image" required>
