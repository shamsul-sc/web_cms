                ...
                <div class="card shadow-lg">
                        ...
                        <form action="{{ route('dashboard.media_cover_update', $getMedia->id) }}" method="POST"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 mt-4 outlined-input-container">
                                    <input type="text" id="media_name" name="media_name" class="form-control"
                                        placeholder="" value="{{ old('media_name', $getMedia->media_name) }}"
                                        maxlength="255">
                                ...
                                <div class="col-md-6 ">
                                    ...
                                    @if ($getMedia && $getMedia->media_logo)
                                        <img src="{{ asset('/uploads/media_logo/' . $getMedia->media_logo) }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 outlined-input-container">
                                    <input disabled type="url" id="url" name="url" class="form-control"
                                        placeholder="" value="{{ old('url', $getMedia->url) }}" maxlength="255">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12 mt-3 ">
                                    ...
                                    <textarea id="coverage_text" name="coverage_text" class="form-control dynamic-char-count" placeholder="" rows="5">{!! old('coverage_text', $getMedia->coverage_text) !!}"</textarea>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12 mt-3 ">
                                    ...
                                    <textarea id="summary" name="summary" class="form-control dynamic-char-count" placeholder="" rows="5">{!! old('summary', $getMedia->summary) !!}"</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 mt-4 outlined-input-container">
                                    <select class="form-select" name="full_news_image">
                                        ...
                                        <option value="Show"
                                            {{ old('full_news_image', $getMedia->full_news_image) == 'Show' ? 'selected' : '' }}>
                                            Show</option>
                                        <option value="Hide"
                                            {{ old('full_news_image', $getMedia->full_news_image) == 'Hide' ? 'selected' : '' }}>
                                            Hide</option>
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 mt-4 outlined-input-container">
                                    <select class="form-select" name="status">
                                        <option value="" disabled>Select Status</option>
                                        <option value="Show"
                                            {{ old('status', $getMedia->status) == 'Show' ? 'selected' : '' }}>
                                            Show</option>
                                        <option value="Hide"
                                            {{ old('status', $getMedia->status) == 'Hide' ? 'selected' : '' }}>
                                            Hide</option>
                                    </select>
                    ...
                    <div class="row mb-3">
                        <div class="col-12 text-center d-flex justify-content-between align-items-center">
                            <a href="{{ route('dashboard.media_cover_list') }}"
