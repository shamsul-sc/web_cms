                        ...
                        <form action="{{ route('dashboard.testimonial_update', $getTestimonial->id) }}" method="POST"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12  ">
                                    ...
                                    <textarea id="content" name="content" class="form-control dynamic-char-count" placeholder="" rows="5">{!! old('content', $getTestimonial->content) !!}</textarea>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 outlined-input-container">
                                    <input type="number" id="serial" class="form-control" name="serial"
                                        placeholder="  " value="{{ old('serial', $getTestimonial->serial) }}">
                                ...
                                <div class="col-md-6  outlined-input-container">
                                    <select class="form-select" name="status" required>
                                        <option value="" disabled
                                            {{ old('status', $getTestimonial->status) === null ? 'selected' : '' }}>
                                            Select Status
                                        </option>
                                        <option value="Show"
                                            {{ old('status', $getTestimonial->status) == 'Show' ? 'selected' : '' }}>
                                            Show</option>
                                        <option value="Hide"
                                            {{ old('status', $getTestimonial->status) == 'Hide' ? 'selected' : '' }}>
                                            Hide</option>
                                    </select>
