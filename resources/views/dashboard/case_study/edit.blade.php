                        ...
                        <form action="{{ route('dashboard.case_study_update', $getRecord->id) }}" method="POST"
                                    ...
                                    <select id="project_id" name="project_id" class="form-select">
                                        ...
                                        @foreach ($projects as $project)
                                            <option value="{{ $project->id }}"
                                                {{ $getRecord->project_id == $project->id ? 'selected' : '' }}>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <textarea id="introduction_bn" name="introduction_bn" class="form-control dynamic-char-count" maxlength="500"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12 ">
                                    ...
                                    <textarea id="introduction" name="introduction" class="form-control dynamic-char-count" maxlength="500" placeholder=""
                            ...
                            <div class="row mb-6">
                                <div class="col-md-6 outlined-input-container">
                                    ...
                                    <textarea id="case_summary_bn" name="case_summary_bn" class="form-control dynamic-char-count" placeholder=""
                                        rows="5">{!! old('case_summary_bn', $getRecord->case_summary_bn) !!}</textarea>
                                </div>

                                <div class="col-md-6 outlined-input-container">
                                    <label for="case_summary">Case Summary</label>
                                    <textarea id="case_summary" name="case_summary" class="form-control dynamic-char-count" placeholder="" rows="5">{!! old('case_summary', $getRecord->case_summary) !!}</textarea>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 outlined-input-container">
                                    <select id="state" name="state" class="form-select">
                                        <option value="Planning"
                                            {{ old('state', $getRecord->state) == 'Planning' ? 'selected' : '' }}>
                                            Planning</option>

                                        <option value="Running"
                                            {{ old('state', $getRecord->state) == 'Running' ? 'selected' : '' }}>
                                            Running</option>

                                        <option value="Finished"
                                            {{ old('state', $getRecord->state) == 'Finished' ? 'selected' : '' }}>
                                            Finished</option>
                                    </select>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6 outlined-input-container">
                                    <select id="urgent_case" name="urgent_case" class="form-select">
                                        <option value="Yes"
                                            {{ old('urgent_case', $getRecord->urgent_case) == 'Yes' ? 'selected' : '' }}>
                                            Yes</option>

                                        <option value="No"
                                            {{ old('urgent_case', $getRecord->urgent_case) == 'No' ? 'selected' : '' }}>
                                            No</option>
                                ...
                                <div class="col-md-6 outlined-input-container">
                                    <select class="form-select" name="featured_case" required>
                                        ...
                                        <option value="Yes"
                                            {{ old('featured_case', $getRecord->featured_case) == 'Yes' ? 'selected' : '' }}>
                                            Yes</option>

                                        <option value="No"
                                            {{ old('featured_case', $getRecord->featured_case) == 'No' ? 'selected' : '' }}>
                                            No</option>
                                    </select>
