        ...
        <div class="col-xxl-6">
            <div class="card ">
                ...
                <div class="card-header align-items-center d-flex text-white" style="background-color: rgb(93, 198, 93);">
                    <h4 class="card-title mb-0 flex-grow-1 ">Edit Excursion Committee Member</h4>
                </div>
                <div class="card-body ">
                    <div class="live-preview">
                        <form action="{{ route('ec-member.update', $getSingleRecord->id) }}" method="POST">
                            {{ csrf_field() }}
                            @method('PUT')
                            <div class="row">
                                    ...
                                    <select id="user_id" name="user_id" class="form-select">
                                        ...
                                        @foreach ($getUser as $user)
                                            <option value="{{ $user->id }}"
                                                {{ $getSingleRecord->user_id == $user->id ? 'selected' : '' }}>
                                    ...
                                    <select id="ec_position_id" name="ec_position_id" class="form-select">
                                        ...
                                        @foreach ($getEcPosition as $position)
                                            <option value="{{ $position->id }}"
                                                {{ $getSingleRecord->ec_position_id == $position->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-12 outlined-input-container">
                                    <select id="ec_id" name="ec_id" class="form-select">
                                        ...
                                        @foreach ($getEcSerial as $serial)
                                            <option
                                                value="{{ $serial->id }}"{{ $getSingleRecord->ec_id == $serial->id ? 'selected' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-12 outlined-input-container">
                                    <input type="number" id="serial" class="form-control" name="serial"
                                        value="{{ old('serial', $getSingleRecord->serial) }}" placeholder="">
                    ...
                    <div class="row">
                        <div class="col-12 text-center d-flex justify-content-between align-items-center">
                            <a href="{{ route('ec-member.index') }}" class="btn btn-danger px-5 rounded-pill loadButton">
