...
@section('content')
    ...
    <div class="container py-5 my-4">
        ...
        <div class="row">
            <div class="col-lg-4">
                <p>মানুষের মৌলিক চাহিদার গুরুত্বপূর্ণ একটি হলো চিকিৎসা। ট্রিটমেন্ট কমিউনিটি ফাউন্ডেশন চিকিৎসা সংক্রান্ত একটি
                    অরাজনৈতিক ও অলাভজনক সামাজিক স্বেচ্ছাসেবী সংগঠন হিসেবে রোগীদের কল্যাণে অনলাইন ও অফলাইন উভয় মাধ্যমে কাজ
                    করে যাচ্ছে।</p>
                <p>আমাদের স্বপ্ন, বাংলাদেশের মানুষের কাছে চিকিৎসা বিষয়ক তথ্য সহজ থেকে সহজতর হবে। মানুষ রোগকে জয় করবে পূর্ণ
                    আত্মবিশ্বাসে, সবার প্রার্থনায়। আমার, আপনার ও আমাদের একটু ইচ্ছে ও সাহায্যই পারে আমাদের চারপাশকে সুন্দর
                    করতে।</p>
            </div>
            <div class="col-lg-4">
                ...
                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi
                    euismod, sed porta est consectetur. Vestibulum auctor felis eget orci semper vestibulum. </p>
                <h3 class="alternative-font-4 text-color-primary text-4-5 font-weight-bold mb-1">OUR VISION</h3>
                <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi
                    euismod, sed porta est consectetur. Vestibulum auctor felis eget orci semper vestibulum. Pellentesque
                    ultricies nibh gravida. </p>
            </div>
            <div class="col-lg-4">
                <h3 class="alternative-font-4 text-color-primary text-4-5 font-weight-bold mb-1">WE HAVE EARNED THE TRUST
                </h3>
                <p class="pb-2 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi
                ...
                <ul class="list list-unstyled d-lg-flex d-xl-block align-items-center justify-content-lg-center mb-4">
                    <li class="mb-lg-0 mb-xl-3">
                        ...
                        <a href="tel:0123456789"
                            class="text-color-dark text-color-hover-primary font-weight-bold text-decoration-none text-5">(800)
                            123-4657</a>
                    </li>
                    <li class="mx-lg-5 mx-xl-0 mb-3 mb-lg-0 mb-xl-3">
                        ...
                        <a href="mailto:porto@portotheme.com"
                            class="text-color-dark text-color-hover-primary text-decoration-none text-4">porto@portotheme.com</a>
                    </li>
    ...
    <div class="container pb-5 my-5">
        ...
        <div class="row">
            <div class="col">
                <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi
                    euismod, sed porta est consectetur. Vestibulum auctor felis eget orci semper vestibulum. Pellentesque
                    ultricies nibh gravida, accumsan libero luctus, molestie nunc. Lorem ipsum dolor sit amet, consectetur
                    adipiscing elit. Sed imperdiet libero id nisi euismod, sed porta est consectetur. Vestibulum auctor
                    felis eget orci semper vestibulum. Pellentesque ultricies nibh gravida.</p>
            </div>
        </div>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card border-0 border-radius-0 custom-box-shadow-1">
                    <div class="card-body text-center p-4 py-5">
                        ...
                        <p class="mb-0">Cras a elit sit amet leo accumsan volutpat. Suspendisse hendrerit vehicula leo,
                            vel efficitur felis ultrices non. Integer aliquet ullamcorper dolor, quis sollicitudin.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
