                ...
                <div class="header-row">
                        ...
                        <div class="header-row">
                            <ul class="list list-unstyled list-inline mb-0">
                                <li class="list-inline-item text-color-dark me-md-4 mb-0">
                                    ...
                                    <a href="tel:+8801516130562" class="text-color-dark text-color-hover-primary text-decoration-none">
                                ...
                                <li class="list-inline-item text-color-dark me-4 mb-0 d-none d-md-inline-block">
                                    ...
                                    <a href="mailto:info@tcf.org.bd" class="text-color-dark text-color-hover-primary text-decoration-none text-2">
                                        info@tcf.org.bd
                                    </a>
                                </li>
                    ...
                    <div class="header-column justify-content-end">
                        <div class="header-row">
                            ...
                            <a href="#" class="btn btn-primary btn-px-4 py-3 font-weight-bold text-2 rounded-0">JOIN US</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="header-column">
                    <div class="header-row">
                        <div class="header-logo">
                            <a href="{{ url('/') }}">
                                <img src="img/demos/law-firm-2/logo.png" class="" width="" height="70" data-sticky-height="50" alt="" />
                            </a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="header-nav-main header-nav-main-text-capitalize header-nav-main-effect-2 header-nav-main-sub-effect-1">
                                <nav class="collapse">
                                    <ul class="nav nav-pills" id="mainNav">
                                        ...
                                        <li class="dropdown">
                                            <a href="demo-law-firm-2-practice-areas.html" class="dropdown-item dropdown-toggle">Members</a>
                                            <ul class="dropdown-menu border-radius-0">
                                                <li>
                                                    <a href="demo-law-firm-2-practice-areas-detail.html" class="nav-link">Family Law</a>
                                                </li>
                                        ...
                                        <li class="dropdown">
                                            <a href="demo-law-firm-2-practice-areas.html" class="dropdown-item dropdown-toggle">Projects</a>
                                            <ul class="dropdown-menu border-radius-0">
                                                <li>
                                                    <a href="demo-law-firm-2-practice-areas-detail.html" class="nav-link">Family Law</a>
                                                </li>
                                        ...
                                        <li class="dropdown">
                                            <a href="demo-law-firm-2-practice-areas.html" class="dropdown-item dropdown-toggle">Media</a>
                                            <ul class="dropdown-menu border-radius-0">
                                                <li>
                                                    <a href="demo-law-firm-2-practice-areas-detail.html" class="nav-link">Family Law</a>
                                                </li>
