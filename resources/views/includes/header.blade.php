                ...
                <div class="header-row">
                    ...
                    <div class="header-column justify-content-end">
                        <div class="header-row">
                            ...
                            <a href="demo-law-firm-2-contact.html" class="btn btn-primary btn-px-4 py-3 font-weight-bold text-2 rounded-0 ms-lg-4">JOIN US</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="header-column">
                    <div class="header-row">
                        <div class="header-logo">
                            <a href="{{ url('/') }}">
                                <img src="img/demos/law-firm-2/logo.png" class="" width="" height="80" alt="" />
                            </a>
                        </div>
                    </div>
                </div>
