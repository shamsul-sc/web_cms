        ...
        <div class="col-xl-12">
            ...
            <div class="card shadow-lg">
                ...
                <div class="card-body mt-2">
                    ...
                    <form action="<?php echo e(route('dashboard.update',$getRecord->id)); ?>" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6 outlined-input-container">
                                <select id="cat_id" name="cat_id" class="form-select">
                                    ...
                                    <option value="<?php echo e($category->id); ?>" <?php echo e($category->id == $getRecord->cat_id ? 'selected' : ''); ?>>
                        ...
                        <div class="row">
                            <div class="col-md-6 outlined-input-container">
                                <input type="text" id="project_title" name="project_title"
                                    value="<?php echo e(old('project_title',$getRecord->project_title)); ?>" class="form-control"
                                    placeholder="" maxlength="255" required>
                                <label for="project_title">Project Title <span class="required">*</span></label>
                            </div>
                            <div class="col-md-6 outlined-input-container">
                                <input type="text" id="slug" name="slug"
                                    value="<?php echo e(old('slug',$getRecord->slug)); ?>" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-md-6 outlined-input-container">
                                <input type="text" id="project_title_bn" name="project_title_bn"
                                    value="<?php echo e(old('project_title_bn',$getRecord->project_title_bn)); ?>" class="form-control"
                                    placeholder="" maxlength="255" required>
                            ...
                            <div class="col-md-6 outlined-input-container">
                                <select id="joint_project" name="joint_project" class="form-select" required>
                                    <option value="" disabled <?php echo e(old('joint_project', $getRecord->joint_project) ===
                                        null ? 'selected' :
                                        ''); ?>>
                                        Select Project
                                    </option>
                                    <option value="No" <?php echo e(old('joint_project', $getRecord->joint_project) == 'No' ? 'selected'
                                        : ''); ?>>No</option>
                                    <option value="Yes" <?php echo e(old('joint_project', $getRecord->joint_project) == 'Yes' ?
                                        'selected' : ''); ?>>Yes</option>
                                </select>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 outlined-input-container">
                                <input type="number" id="project_approx_budget" name="project_approx_budget"
                                    value="<?php echo e(old('project_approx_budget',$getRecord->project_approx_budget)); ?>"
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12 ">
                                ...
                                <textarea id="project_summary" name="project_summary"
                                    class="form-control dynamic-char-count" placeholder="" rows="3"><?php echo old('project_summary',$getRecord->project_summary); ?></textarea>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12 ">
                                ...
                                <textarea id="project_summary_bn" name="project_summary_bn"
                                    class="form-control dynamic-char-count" placeholder="" rows="3"><?php echo old('project_summary_bn',$getRecord->project_summary_bn); ?></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 outlined-input-container">
                                <input type="file" id="project_image" name="project_image"
                                    value="<?php echo e(old('project_image',$getRecord->project_image)); ?>" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-md-6 outlined-input-container">
                                <input type="url" id="youtube_video_link" name="youtube_video_link" value="<?php echo e(old('youtube_video_link',$getRecord->youtube_video_link)); ?>"
                        ...
                        <div class="row">
                            <div class="col-md-6 outlined-input-container">
                                <select id="featured_project" name="featured_project" class="form-select">
                                    <option value="" disabled <?php echo e(old('featured_project', $getRecord->featured_project)
                                        ===
                                        null ? 'selected' :
                                        ''); ?>>
                                    <option value="No" <?php echo e(old('featured_project', $getRecord->featured_project) == 'No'
                                        ? 'selected'
                                        : ''); ?>>No</option>
                                    <option value="Yes" <?php echo e(old('featured_project', $getRecord->featured_project) == 'Yes'
                                        ? 'selected'
                                        : ''); ?>>Yes</option>
                                </select>
                            ...
                            <div class="col-md-6 outlined-input-container">
                                <select id="state" name="state" class="form-select">
                                    <option value="" disabled <?php echo e(old('state', $getRecord->state) ===
                                        null ? 'selected' :
                                        ''); ?>>
                                        Select State
                                    <option value="Planning" <?php echo e(old('state', $getRecord->status) == 'Planning' ?
                                        'selected'
                                        : ''); ?>>Planning</option>
                                    <option value="Running" <?php echo e(old('state', $getRecord->status) == 'Running' ?
                                        'selected'
                                        : ''); ?>>Running</option>
                                    <option value="Finished" <?php echo e(old('state', $getRecord->status) == 'Finished' ?
                                        'selected'
                                        : ''); ?>>Finished</option>
                                </select>
                            ...
                            <div class="col-md-6 outlined-input-container">
                                <select class="form-select" name="status" required>
                                    <option value="" disabled <?php echo e(old('status', $getRecord->status) ===
                                        null ? 'selected' :
                                        ''); ?>>
                                        Select
                            ...
                            <div class="col-md-6 outlined-input-container">
                                <input type="number" id="serial" name="serial"
                                    value="<?php echo e(old('category_name',$getRecord->serial)); ?>" class="form-control"
...
<?php echo $__env->make('admin_dashboard_includes.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\LARAVEL\web_cms\resources\views/dashboard/project/edit.blade.php ENDPATH**/ ?>