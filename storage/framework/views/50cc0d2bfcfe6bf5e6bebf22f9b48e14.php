<?php $__env->startSection('title', 'Projects | Treatment Community Foundation'); ?>
    ...
    <div class="container py-4">
        <div class="row">
            <div class="col text-center">
                <h1 class="text-color-light font-weight-bold text-10"><?php echo e($title); ?></h1>
            </div>
        </div>
    </div>
</section>
...
<div class="container py-5 my-4">
    <div class="row row-gutter-sm py-2">        
        <?php if($jointProjects && $jointProjects->count()): ?>
            <?php $__currentLoopData = $jointProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <a href="<?php echo e(url('project',$project->slug )); ?>" class="text-decoration-none">
                        <div class="card custom-card-style-1 border-0 border-radius-0 custom-box-shadow-1">
                            ...
                            <div class="card-body text-center px-4 py-5">
                                <h2 class="card-title alternative-font-4 text-color-dark font-weight-semibold line-height-1 text-5 mb-3"><?php echo e(app()->getLocale() == 'en' ? $project->project_title : $project->project_title_bn); ?></h2>
                                <!-- <p class="text-color-grey positive-ls-3 mb-3"><?php echo e(app()->getLocale() == 'en' ? $project->project_approx_budget : $project->project_approx_budget); ?></p> -->
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\LARAVEL\web_cms\resources\views/pages/jointProjects.blade.php ENDPATH**/ ?>