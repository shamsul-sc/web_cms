                    ...
                    <a href="<?php echo e(url('project',$project->slug )); ?>" class="text-decoration-none">
                        <div class="card custom-card-style-1 border-0 border-radius-0 custom-box-shadow-1">
                            ...
                            <div class="card-body text-center px-4 py-5">
                                ...
                                <!-- <p class="text-color-grey positive-ls-3 mb-3"><?php echo e(app()->getLocale() == 'en' ? $project->category_name : $project->category_name_bn); ?></p> -->
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\LARAVEL\web_cms\resources\views/pages/projects.blade.php ENDPATH**/ ?>