<?php $__env->startSection('title', 'Case Study | Treatment Community Foundation'); ?>
    ...
    <div class="container py-4">
        <div class="row">
            <div class="col text-center">
                <h1 class="text-color-light font-weight-bold text-10">Case Study | <?php echo e(app()->getLocale() == 'en' ? $category->category_name : $category->category_name_bn); ?></h1>
            </div>
        </div>
    </div>
</section>
...
<div class="container py-5 my-4">
    <div class="row pb-4">
        <?php if($caseStudies && $caseStudies->count()): ?>
            <?php $animation_delay = 200; ?>
            <?php $__currentLoopData = $caseStudies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $case): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-4 mb-5 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="<?php echo e($animation_delay); ?>">
        ...
        <div class="py-5">
            <a href="demo-law-firm-2-attorney-detail.html" class="text-decoration-none">
                <div class="card custom-card-style-1 border-0 border-radius-0 custom-box-shadow-1">
                    <img src="/uploads/category/thumbnail/<?php echo e($project->project_image); ?>" alt="John Doe Image" />
                    <div class="card-body text-center px-4 py-5">
                        <h2 class="card-title alternative-font-4 text-color-dark font-weight-semibold line-height-1 text-5 mb-1"><?php echo e(app()->getLocale() == 'en' ? $project->project_title : $project->project_title_bn); ?></h2>
                        <!-- <p class="text-color-grey positive-ls-3 mb-3">CEO & FOUNDER</p> -->
                        <p class="font-weight-light text-color-dark line-height-7 mb-2"><?php echo app()->getLocale() == 'en' ? $project->project_summary : $project->project_summary_bn; ?></p>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\LARAVEL\web_cms\resources\views/pages/categoryCaseStudies.blade.php ENDPATH**/ ?>