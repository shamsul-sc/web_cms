...
<?php $__env->startSection('title', 'Home | Treatment Community Foundation'); ?>

<?php $__env->startSection('content'); ?>

<?php echo $__env->make('includes.slider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('includes.projectCarouselWrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="col-md-9 col-lg-6 ps-lg-5">
            <div class="position-relative">
                ...
                <div data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.3, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}">
                    <img src="<?php echo e(asset('img/team-1.jpg')); ?>" class="img-fluid position-relative z-index-1 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="900" alt="" />
                </div>
            </div>
        </div>
    </div>
...
<?php if($featuredProjects && $featuredProjects->count()): ?>
...
<div class="owl-carousel-wrapper position-relative z-index-3 pb-2 mb-2 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="600" style="height: 373px; margin-top: -225px;">
    <div class="owl-carousel owl-theme dots-horizontal-center custom-dots-style-1 dots-dark mb-0" data-plugin-options="{'responsive': {'576': {'items': 2}, '768': {'items': 2}, '992': {'items': 3}, '1200': {'items': 3}, '1440': {'items': 5}}, 'margin': 20, 'stagePadding': 20, 'loop': true, 'nav': false, 'dots': true, 'autoplay': true, 'autoplayTimeout': 3000}">        
        ...
        <div class="py-5">
            <a href="<?php echo e(url('project',$project->slug )); ?>" class="text-decoration-none">
                <div class="card custom-card-style-1 border-0 border-radius-0 custom-box-shadow-1">
                    <img src="/uploads/category/thumbnail/<?php echo e($project->project_image); ?>" class="card-img-top border-radius-0" alt="John Doe Image" />
                    <div class="card-body text-center px-4 py-5">
                        ...
                        <p class="font-weight-light text-color-dark line-height-7 mb-2"><?php echo Str::words(app()->getLocale() == 'en' ? $project->project_summary : $project->project_summary_bn, 20, '...'); ?></p>
            ...
            <div class="col-lg-7 text-center px-lg-0">
                <div class="owl-carousel owl-theme dots-horizontal-center custom-dots-style-1 dots-light mb-0" data-plugin-options="{'responsive': {'576': {'items': 1}, '768': {'items': 1}, '992': {'items': 1}, '1200': {'items': 1}}, 'loop': true, 'nav': false, 'dots': true, 'autoplay': true, 'autoplayTimeout': 5000}">
                    ...
                    <div class="testimonial testimonial-style-2">
                        <span class="text-color-light text-6 custom-font-secondary line-height-4 opacity-8 pb-2 mb-0"><?php echo $item->content; ?></span>
                        <div class="divider divider-primary divider-small mt-2 mb-4 pb-2">
                            <hr class="my-4 mx-auto">
                        </div>
                        <div class="testimonial-author">
                            <div class="testimonial-author-thumbnail">
                                <img src="<?php echo e(asset('uploads/author_image/original/'.$item->author_image)); ?>" class="img-fluid rounded-circle" alt="">
                            </div>
                            <p>
                                <strong class="font-weight-extra-bold text-color-light mb-1">
                                    <?php echo e($item->author_name); ?>

                                </strong>
                                <span class="font-weight-light text-color-light">
                                    <?php echo e($item->designation); ?>, <?php echo e($item->company_name); ?>
...
<div class="container pb-3 my-5">
    ...
    <?php if($featuredCases && $featuredCases->count()): ?>   
    ...
    <div class="row">
        <div class="col appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="800">
            <div class="custom-carousel-style-2 owl-carousel owl-theme dots-horizontal-center custom-dots-style-1 dots-dark mb-0" data-plugin-options="{'responsive': {'576': {'items': 1}, '768': {'items': 1}, '992': {'items': 2}, '1200': {'items': 2}}, 'loop': true, 'nav': false, 'dots': true, 'margin': 25, 'stagePadding': 25, 'autoplay': false, 'autoplayTimeout': 3000}">
                <?php $__currentLoopData = $featuredCases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $case): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="pb-5">
                    <a href="<?php echo e(url('case-study',$case->id )); ?>" class="text-decoration-none">
                        <div class="card custom-card-style-2 border-0 border-radius-0">
                            <div class="card-img-top">
                                <img src="/uploads/case_image/thumbnail/<?php echo e($case->case_image); ?>" class="img-fluid" alt="" />
                            </div>
                            <div class="card-body">
                                <span class="d-block text-color-grey positive-ls-2 mb-0"><?php echo e(app()->getLocale() == 'en' ? $case->category_name : $case->category_name_bn); ?></span>
                                <h4 class="text-color-dark font-weight-medium text-5-5 mb-2"><em><?php echo e(app()->getLocale() == 'en' ? $case->case_title : $case->case_title_bn); ?></em></h4>
    ...
    <?php if($galleryPhotos && $galleryPhotos->count()): ?> 
    ...
    <div class="row">
        <div class="col">
            <div class="owl-carousel owl-theme carousel-center-active-item" data-plugin-options="{'responsive': {'0': {'items': 1}, '476': {'items': 1}, '768': {'items': 3}, '992': {'items': 3}, '1200': {'items': 3}}, 'autoplay': true, 'autoplayTimeout': 3000, 'dots': true, 'margin': 20}">
                ...
                <div>
                    <img class="img-fluid" src="<?php echo e(asset('uploads/gallery_photo/thumbnail/' . $photo->image)); ?>" alt="">
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\LARAVEL\web_cms\resources\views/pages/home.blade.php ENDPATH**/ ?>