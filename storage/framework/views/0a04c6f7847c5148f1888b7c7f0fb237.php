    ...
    <div class="container py-4">
        <div class="row">
            <div class="col text-center">
                <h1 class="text-color-light font-weight-bold text-10"><?php echo e(app()->getLocale() == 'en' ?$getRecord->project_title : $getRecord->project_title_bn); ?></h1>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="card border-0 border-radius-0 custom-box-shadow-1 px-2 mb-5">
                    <div class="card-body p-4 my-3">
                        ...
                        <ul class="custom-list-style-1 list list-unstyled">
                            ...
                            <li class="<?php echo e($getRecord->id == $category->id ? 'active' : ''); ?>">
                                <a href="" class="text-decoration-none <?php echo e($getRecord->id == $category->id ? 'text-color-primary' : 'text-color-dark text-color-hover-primary'); ?>"><?php echo e(app()->getLocale() == 'en' ? $category->category_name : $category->category_name_bn); ?></a>
                            </li>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\LARAVEL\web_cms\resources\views/pages/projectDetails.blade.php ENDPATH**/ ?>