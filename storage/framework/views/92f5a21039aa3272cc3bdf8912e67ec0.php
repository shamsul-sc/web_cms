        ...
        <div class="card ">
            ...
            <div class="card-body ">
                <div class="live-preview">
                    <form action="<?php echo e(route('dashboard.gallery_album_insert')); ?>" method="POST"
                            ...
                            <div class="col-md-6 outlined-input-container">
                                <select id="type_id" name="type_id" class="form-select">
                                    ...
                                    <option value="<?php echo e($type->id); ?>">
                                        <?php echo e(app()->getLocale() == 'en' ? $type->type_name : $type->type_name); ?>

                                    </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                                </select>
                                <label for="album_id">Album type<span class="required">*</span></label>
                            </div>
                        </div>
                        <div class="row ">
...
<?php echo $__env->make('admin_dashboard_includes.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\LARAVEL\web_cms\resources\views/dashboard/gallery_album/add.blade.php ENDPATH**/ ?>