        ...
        <div class="card ">
            ...
            <div class="card-body ">
                <div class="live-preview">
                    <form action="<?php echo e(route('dashboard.gallery_photo_insert')); ?>" method="POST"
                            ...
                            <div class="col-md-12 outlined-input-container">
                                <select id="album_id" name="album_id" class="form-select">
                                    ...
                                    <option value="<?php echo e($album->id); ?>">
                                        <?php echo e(app()->getLocale() == 'en' ? $album->album_name : $album->album_name); ?>
...
<?php echo $__env->make('admin_dashboard_includes.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\LARAVEL\web_cms\resources\views/dashboard/gallery_photo/add.blade.php ENDPATH**/ ?>