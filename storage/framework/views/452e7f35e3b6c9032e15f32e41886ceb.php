...
<ul class="navbar-nav " id="sortable">
    ...
    <li class="nav-item">
        ...
        <div class="collapse menu-dropdown" id="sidebarServices">
            <ul class="nav nav-sm flex-column">
                <li class="nav-item">
                    <a href="<?php echo e(route('dashboard.list')); ?>" class="nav-link" data-key="t-starter">Project List</a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('dashboard.category_list')); ?>" class="nav-link" data-key="t-starter">Category
                        List</a>
                </li>
    ...
    <li class="nav-item">
        ...
        <div class="collapse menu-dropdown" id="sidebarPages">
            <ul class="nav nav-sm flex-column">
                <li class="nav-item">
                    <a href="<?php echo e(route('dashboard.case_study_list')); ?>" class="nav-link" data-key="t-category-list">
                        CaseStudy List
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('dashboard.follow_up_list')); ?>" class="nav-link" data-key="t-category-list">
                        FollwUp List
                    </a>
                </li>
            </ul>
    ...
    <li class="nav-item">
        ...
        <div class="collapse menu-dropdown" id="sidebarPages">
            <ul class="nav nav-sm flex-column">
                <li class="nav-item">
                    <a href="<?php echo e(route('dashboard.gallery_type_list')); ?>" class="nav-link" data-key="t-category-list">
                        Gallery Type
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('dashboard.gallery_photo_list')); ?>" class="nav-link" data-key="t-category-list">
                        Gallery Photo
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('dashboard.gallery_album_list')); ?>" class="nav-link" data-key="t-category-list">
                        Gallery Albums
                    </a>
                </li>
            </ul>
    ...
    <li class="nav-item">
        ...
        <div class="collapse menu-dropdown" id="sidebarPages">
            <ul class="nav nav-sm flex-column">
                <li class="nav-item">
                    <a href="<?php echo e(route('dashboard.faq_list')); ?>" class="nav-link" data-key="t-category-list">
                        FAQ List
                    </a>
                    <a href="<?php echo e(route('dashboard.faq_category_list')); ?>" class="nav-link" data-key="t-category-list">
                        FAQ Category
                    </a>
                </li>
            </ul>
    ...
    <li class="nav-item">
        ...
        <div class="collapse menu-dropdown" id="sidebarServices">
            <ul class="nav nav-sm flex-column">
                <li class="nav-item">
                    <a href="<?php echo e(route('dashboard.testimonial_list')); ?>" class="nav-link"
    ...
    <li class="nav-item">
        ...
        <div class="collapse menu-dropdown" id="sidebarServices">
            <ul class="nav nav-sm flex-column">
                <li class="nav-item">
                    <a href="<?php echo e(route('dashboard.media_cover_list')); ?>" class="nav-link"
...
</ul><?php /**PATH E:\LARAVEL\web_cms\resources\views/admin_dashboard_includes/slider.blade.php ENDPATH**/ ?>