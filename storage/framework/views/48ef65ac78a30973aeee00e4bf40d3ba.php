                    ...
                    <a href="<?php echo e(url('project/category',$category->slug)); ?>" class="text-decoration-none">
                        <div class="card custom-card-style-1 border-0 border-radius-0 custom-box-shadow-1">
                            <div class="card-body text-center px-4 py-5">
                                <img width="60" height="60" src="<?php echo e(asset('img/demos/law-firm-2/icons/icon-heart-hands.svg')); ?>" alt="" data-icon data-plugin-options="{'onlySVG': true, 'extraClass': 'svg-stroke-color-primary custom-stroke-width-1 mt-2 mb-4 pb-3'}" />
...
</div><?php /**PATH E:\LARAVEL\web_cms\resources\views/includes/projectCarouselWrapper.blade.php ENDPATH**/ ?>