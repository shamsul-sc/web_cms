        ...
        <div class="col-xl-12">
            ...
            <div class="card shadow-lg">
                ...
                <div class="card-body  mt-2">
                    ...
                    <form action="<?php echo e(route('dashboard.faq_insert')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 outlined-input-container">
                                <select id="faq_cat_id" name="faq_cat_id" class="form-select">
                                    ...
                                    <option value="<?php echo e($faq_category->id); ?>"><?php echo e($faq_category->faq_cat_name); ?></option>
...
<?php echo $__env->make('admin_dashboard_includes.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\LARAVEL\web_cms\resources\views/dashboard/faq/faq_add.blade.php ENDPATH**/ ?>