...
Route::post('/registration',[AuthController::class, 'InsertRegistration'])->name('auth.register_insert');
Route::get('/login',[AuthController::class, 'login'])->name('auth.login');
Route::post('/login',[AuthController::class, 'InsertLogin'])->name('auth.login_insert');
